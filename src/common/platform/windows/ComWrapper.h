#ifndef TWILIGHT_COMMON_PLATFORM_WINDOWS_COMWRAPPER_H
#define TWILIGHT_COMMON_PLATFORM_WINDOWS_COMWRAPPER_H
...
using DxgiSwapChain1 = ComWrapper<IDXGISwapChain1>;
